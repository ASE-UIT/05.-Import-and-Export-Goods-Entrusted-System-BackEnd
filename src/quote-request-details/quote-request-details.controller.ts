...
export class QuoteReqDetailsController {
    ...
    @ApiResponse({
        ...
        example: new NotFoundException('No quote request detail found').getResponse()
    })
    ...
    @ApiResponse({
        ...
        type: createResponseType('Quote request detail successfully created', QuoteReqDetail)
    })
    @ApiResponse({
        status: 400,
    ...
    @ApiResponse({
        ...
        type: createResponseType('Quote request detail successfully updated', QuoteReqDetail)
    })
    @ApiResponse({
        status: 400,
        description: 'Invalid foreign key.',
    ...
    @ApiResponse({
        ...
        type: NotFoundException,
        example: new NotFoundException('Quote request detail id does not exists in database').getResponse()
    })
    @ApiBody({
